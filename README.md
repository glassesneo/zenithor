...
- **Graphics**: 2D Point/Line/Triangle/Rectangle/Circle rendering via Sokol GL; optional Color component; RenderingOptions resource (pass action + pipeline bindings).
